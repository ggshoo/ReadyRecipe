...
describe("api-clients", () => {
  ...
  describe("isSpoonacularAvailable", () => {
    it("should return false when API key is not set", async () => {
      ...
      const { isSpoonacularAvailable } = await import("../lib/api-clients");
  ...
  describe("searchRecipesByIngredients", () => {
    it("should throw error when API key is not configured", async () => {
      delete process.env.SPOONACULAR_API_KEY;
      const { searchRecipesByIngredients } = await import("../lib/api-clients");
      
      await expect(searchRecipesByIngredients(["chicken", "rice"])).rejects.toThrow(
    ...
    it("should throw error when ingredients array is empty", async () => {
      ...
      await expect(searchRecipesByIngredients([])).rejects.toThrow(
    ...
    it("should throw error when ingredients contain empty strings", async () => {
      ...
      await expect(searchRecipesByIngredients(["chicken", ""])).rejects.toThrow(
  ...
  describe("getRecipeById", () => {
    it("should throw error when API key is not configured", async () => {
      delete process.env.SPOONACULAR_API_KEY;
      const { getRecipeById } = await import("../lib/api-clients");
